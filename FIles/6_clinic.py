...
class InsertWindow:
    def __init__(self):
        ...
        tkinter.Label(self.userdata_frame_1, font=("times new roman",10,"bold"),text="Patient Gender").grid(row=0, column=3)
        ...
        tkinter.Label(self.userdata_frame_1, font=("times new roman",10,"bold"),text="Patient Blood Type").grid(row=2, column=3)
        ...
        self.bloodListBox = tkinter.ttk.Combobox(self.userdata_frame_1, values=self.bloodListType, width=25)
        ...
        self.bloodListBox.grid(column=3, row=3) 
        ...
        tkinter.Label(self.userdata_frame_2, font=("times new roman",10,"bold"),text="Contact Number").grid(column=0, row=0)
        tkinter.Label(self.userdata_frame_2, font=("times new roman",10,"bold"),text="Patient Address").grid(column=0, row=1)
        self.addressEntry = tkinter.Entry(self.userdata_frame_2, textvariable=self.address)
        self.contactNumberEntry = tkinter.Entry(self.userdata_frame_2, textvariable=self.contactNumber)
        self.addressEntry.grid(column=1, row=0)
        self.contactNumberEntry.grid(column=1, row=1)
        ...
        tkinter.Label(self.doctor_frame, font=("times new roman",10,"bold"),text="Symptoms").grid(column=0, row=0)
        tkinter.Label(self.doctor_frame, font=("times new roman",10,"bold"),text="Rubrics").grid(column=0, row=1)
        tkinter.Label(self.doctor_frame, font=("times new roman",10,"bold"),text="Medicine").grid(column=0, row=2)
        tkinter.Label(self.doctor_frame, font=("times new roman",10,"bold"),text="Amount paid").grid(column=1, row=2)
        tkinter.Label(self.doctor_frame, font=("times new roman",10,"bold"),text="Notes").grid(column=0, row=4)
       
        
        
        self.symptomEntry = tkinter.Entry(self.doctor_frame, textvariable=self.symptom)
        self.rubricEntry = tkinter.Entry(self.doctor_frame, textvariable=self.rubric)
        self.medicineEntry = tkinter.Entry(self.doctor_frame, textvariable=self.medicine)
        self.notesEntry = tkinter.Entry(self.doctor_frame, textvariable=self.notes)
        self.amountEntry = tkinter.Entry(self.doctor_frame, textvariable=self.amount)
        
        self.symptomEntry.grid(column=1, row=0)
        self.rubricEntry.grid(column=1, row=1)
        self.medicineEntry.grid(column=0, row=3)
        self.notesEntry.grid(column=1, row=3)
        self.amountEntry.grid( column=0, row=5)
        ...
        # Button widgets
        tkinter.Button(self.end_frame, width=10, fg=fg_color, bg=bg_color, font=("times new roman",10,"bold"), text="Insert", command=self.Insert).grid(pady=15, padx=5, column=1,
                                                                                       row=17)
        tkinter.Button(self.end_frame, width=10, fg=fg_color, bg=bg_color, font=("times new roman",10,"bold"), text="Reset", command=self.Reset).grid(pady=15, padx=5, column=2, row=17)
        tkinter.Button(self.end_frame, width=10, fg=fg_color, bg=bg_color, font=("times new roman",10,"bold"), text="Close", command=self.window.destroy).grid(pady=15, padx=5, column=3,
                                                                                              row=17)
